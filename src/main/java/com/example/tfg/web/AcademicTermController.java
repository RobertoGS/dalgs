...
//		if (courses != null)
	...
	protected String formModifyActivities(@PathVariable("academicId") Long id_academic,
	...
	{	
		...
		if (!result.hasErrors()) {
			...
			boolean success = serviceAcademicTerm.modifyAcademicTerm(newTerm,academicId);
			if (success)
				return "redirect:/academicTerm/page/0.htm";
